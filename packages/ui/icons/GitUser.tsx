...
export const GitUser: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    viewBox="0 0 97 104.44"
    fill="currentColor"
  >
    {/* <!-- Git logo --> */}
    ...
    {/* User badge — scaled 1.8x from center (74, 74) */}
    <circle cx="74" cy="74" r="32" fill="var(--background, white)" />
    <circle cx="74" cy="65" r="9.9" />
    <path d="M53.3 93.1c0-11.432 9.268-20.7 20.7-20.7s20.7 9.268 20.7 20.7" />
  </svg>
);
