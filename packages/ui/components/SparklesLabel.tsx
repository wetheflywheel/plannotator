...
const SparklesLabel = ({ text = "Sparkle Text" }) => {
  const isCodingAgent = text.toLowerCase().includes("coding agent");

  const styles: CSSProperties = !isCodingAgent
    ? {
        position: "absolute",
        top: "1px",
        right: "-14px",
  ...
  return (
    ...
    >
      {text}
      <svg width="16" height="16" viewBox="0 0 128 128" style={styles}>
        {/* Big star */}
        <g
          style={{
